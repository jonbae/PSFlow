...
and the JS surface. It re-exports all 60 public symbols, converting each to a
...
gate can scope itself to the converted set and grow with the staging instead of
