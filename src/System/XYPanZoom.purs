...
-- | PanZoomInstance`. d3 wiring is delegated to `System.FFI.D3Zoom`; the
...
import System.FFI.D3Selection (D3Selection, d3Select)
...
import System.Utils.General (clamp, isNumeric)
...
import System.XYPanZoom.Filter (createFilter)
