...
Derived from 97 scenario(s) whose traces are on disk, captured against vendored `@xyflow/react` 12.11.0.
...
| `AriaLabelConfig` | dom | driven | `.react-flow__node[aria-describedby]` | `arrow-key-selected-node` +94 more |
...
| `BaseEdge` | dom | driven | `path.react-flow__edge-path` | `arrow-key-selected-node` +91 more |
| `BaseEdgeProps` | dom | driven | `path.react-flow__edge-path[d]` | `arrow-key-selected-node` +91 more |
| `BezierEdge` | dom | driven | `.react-flow__edge-default` | `arrow-key-selected-node` +91 more |
| `BezierEdgeProps` | dom | driven | `.react-flow__edge-default path.react-flow__edge-path` | `arrow-key-selected-node` +91 more |
| `ColorMode` | dom | driven | `.react-flow.light` | `arrow-key-selected-node` +95 more |
...
| `Edge` | dom | driven | `.react-flow__edge[data-id]` | `arrow-key-selected-node` +91 more |
| `EdgeLabelOptions` | dom | driven | `.react-flow__edge-textbg` | `background-custom-bgcolor` +52 more |
...
| `EdgeText` | dom | driven | `.react-flow__edge-textwrapper` | `background-custom-bgcolor` +52 more |
| `EdgeTextProps` | dom | driven | `text.react-flow__edge-text` | `background-custom-bgcolor` +52 more |
...
| `EdgeWrapperProps` | dom | driven | `.react-flow__edge` | `arrow-key-selected-node` +91 more |
| `Handle` | dom | driven | `.react-flow__handle` | `arrow-key-selected-node` +92 more |
| `HandleProps` | dom | driven | `.react-flow__handle[data-handlepos]` | `arrow-key-selected-node` +92 more |
| `HandleType` | dom | driven | `.react-flow__handle.source` | `arrow-key-selected-node` +92 more |
...
| `Node` | dom | driven | `.react-flow__node[data-id]` | `arrow-key-selected-node` +94 more |
| `NodeOrigin` | dom | driven | `.react-flow__node[style*=translate]` | `arrow-key-selected-node` +94 more |
...
| `NodeWrapperProps` | dom | driven | `.react-flow__node` | `arrow-key-selected-node` +94 more |
| `Panel` | dom | driven | `.react-flow__panel` | `arrow-key-selected-node` +96 more |
| `PanelPosition` | dom | driven | `.react-flow__panel.top` | `mount-baseline--chrome-panels` +4 more |
| `PanelProps` | dom | driven | `.react-flow__panel` | `arrow-key-selected-node` +96 more |
| `ProOptions` | dom | driven | `.react-flow__attribution` | `arrow-key-selected-node` +96 more |
| `ReactFlow` | dom | driven | `.react-flow` | `arrow-key-selected-node` +96 more |
| `ReactFlowProps` | dom | driven | `.react-flow[data-testid]` | `arrow-key-selected-node` +96 more |
| `ReactFlowProvider` | dom | driven | `.react-flow` | `arrow-key-selected-node` +96 more |
...
| `Viewport` | dom | driven | `.react-flow__viewport[style*=transform]` | `arrow-key-selected-node` +96 more |
| `ViewportPortal` | dom | hole | `.react-flow__viewport-portal *` | declared — no issue owns it |
| `XYZPosition` | dom | driven | `.react-flow__node[style*=z-index]` | `arrow-key-selected-node` +94 more |
...
| `OnSelectionChangeFunc` | callbacks | driven | `onSelectionChange` | `arrow-key-selected-node` +94 more |
| `OnSelectionChangeParams` | callbacks | driven | `onSelectionChange` | `arrow-key-selected-node` +94 more |
...
| `ReactFlowInstance` | api | driven | `getNode, getNodes, getEdge, getEdges, toObject, updateNode, updateEdge` | `arrow-key-selected-node` +94 more |
| `ReactFlowJsonObject` | api | driven | `toObject` | `arrow-key-selected-node` +94 more |
...
| `ViewportHelperFunctions` | api | driven | `zoomIn, zoomOut, zoomTo, getZoom, setViewport, getViewport, setCenter, fitBounds` | `arrow-key-selected-node` +94 more |
